...
export { default as llmProxiesTable } from "./llm-proxy";
export { default as llmProxyLabelsTable } from "./llm-proxy-label";
export { default as llmProxyTeamsTable } from "./llm-proxy-team";
export { default as mcpGatewaysTable } from "./mcp-gateway";
export { default as mcpGatewayLabelsTable } from "./mcp-gateway-label";
export { default as mcpGatewayTeamsTable } from "./mcp-gateway-team";
export { default as mcpGatewayToolsTable } from "./mcp-gateway-tool";
