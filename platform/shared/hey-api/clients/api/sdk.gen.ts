 ...
 */
export const bedrockChatCompletionsWithDefaultAgent = <ThrowOnError extends boolean = false>(options: Options<BedrockChatCompletionsWithDefaultAgentData, ThrowOnError>) => (options.client ?? client).post<BedrockChatCompletionsWithDefaultAgentResponses, BedrockChatCompletionsWithDefaultAgentErrors, ThrowOnError>({
 ...
 */
export const bedrockChatCompletionsWithAgent = <ThrowOnError extends boolean = false>(options: Options<BedrockChatCompletionsWithAgentData, ThrowOnError>) => (options.client ?? client).post<BedrockChatCompletionsWithAgentResponses, BedrockChatCompletionsWithAgentErrors, ThrowOnError>({
