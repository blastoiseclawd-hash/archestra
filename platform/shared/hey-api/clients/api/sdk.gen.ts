 ...
 */
export const bedrockConverseWithAgentModel = <ThrowOnError extends boolean = false>(options: Options<BedrockConverseWithAgentModelData, ThrowOnError>) => (options.client ?? client).post<BedrockConverseWithAgentModelResponses, BedrockConverseWithAgentModelErrors, ThrowOnError>({
 ...
 */
export const bedrockConverseWithAgentModelStream = <ThrowOnError extends boolean = false>(options: Options<BedrockConverseWithAgentModelStreamData, ThrowOnError>) => (options.client ?? client).post<BedrockConverseWithAgentModelStreamResponses, BedrockConverseWithAgentModelStreamErrors, ThrowOnError>({
