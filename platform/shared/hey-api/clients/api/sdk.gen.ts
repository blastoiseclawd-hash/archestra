 ...
 */
export const getAllAgentTools = <ThrowOnError extends boolean = false>(options?: Options<GetAllAgentToolsData, ThrowOnError>) => (options?.client ?? client).get<GetAllAgentToolsResponses, GetAllAgentToolsErrors, ThrowOnError>({ url: '/api/mcp-gateway-tools', ...options });

/**
 * Unassign a tool from an MCP gateway
 */
export const unassignToolFromAgent = <ThrowOnError extends boolean = false>(options: Options<UnassignToolFromAgentData, ThrowOnError>) => (options.client ?? client).delete<UnassignToolFromAgentResponses, UnassignToolFromAgentErrors, ThrowOnError>({ url: '/api/mcp-gateways/{mcpGatewayId}/tools/{toolId}', ...options });

/**
 * Assign a tool to an MCP gateway
 */
...
/**
 * Assign multiple tools to multiple MCP gateways in bulk
 */
 ...
 */
export const getAgentTools = <ThrowOnError extends boolean = false>(options: Options<GetAgentToolsData, ThrowOnError>) => (options.client ?? client).get<GetAgentToolsResponses, GetAgentToolsErrors, ThrowOnError>({ url: '/api/mcp-gateways/{mcpGatewayId}/tools', ...options });

/**
 * Update an MCP gateway-tool relationship
 */
 ...
 */
export const getLlmProxies = <ThrowOnError extends boolean = false>(options?: Options<GetLlmProxiesData, ThrowOnError>) => (options?.client ?? client).get<GetLlmProxiesResponses, GetLlmProxiesErrors, ThrowOnError>({ url: '/api/llm-proxy-entities', ...options });

/**
 * Create a new LLM Proxy
 */
export const createLlmProxy = <ThrowOnError extends boolean = false>(options: Options<CreateLlmProxyData, ThrowOnError>) => (options.client ?? client).post<CreateLlmProxyResponses, CreateLlmProxyErrors, ThrowOnError>({
...
/**
 * Get all LLM Proxies without pagination
 */
export const getAllLlmProxies = <ThrowOnError extends boolean = false>(options?: Options<GetAllLlmProxiesData, ThrowOnError>) => (options?.client ?? client).get<GetAllLlmProxiesResponses, GetAllLlmProxiesErrors, ThrowOnError>({ url: '/api/llm-proxy-entities/all', ...options });

/**
 * Get or create default LLM Proxy
 */
export const getDefaultLlmProxy = <ThrowOnError extends boolean = false>(options?: Options<GetDefaultLlmProxyData, ThrowOnError>) => (options?.client ?? client).get<GetDefaultLlmProxyResponses, GetDefaultLlmProxyErrors, ThrowOnError>({ url: '/api/llm-proxy-entities/default', ...options });

/**
 * Delete an LLM Proxy
 */
export const deleteLlmProxy = <ThrowOnError extends boolean = false>(options: Options<DeleteLlmProxyData, ThrowOnError>) => (options.client ?? client).delete<DeleteLlmProxyResponses, DeleteLlmProxyErrors, ThrowOnError>({ url: '/api/llm-proxy-entities/{id}', ...options });

/**
 * Get LLM Proxy by ID
 */
export const getLlmProxy = <ThrowOnError extends boolean = false>(options: Options<GetLlmProxyData, ThrowOnError>) => (options.client ?? client).get<GetLlmProxyResponses, GetLlmProxyErrors, ThrowOnError>({ url: '/api/llm-proxy-entities/{id}', ...options });

/**
 * Update an LLM Proxy
 */
export const updateLlmProxy = <ThrowOnError extends boolean = false>(options: Options<UpdateLlmProxyData, ThrowOnError>) => (options.client ?? client).put<UpdateLlmProxyResponses, UpdateLlmProxyErrors, ThrowOnError>({
...
/**
 * Get all available label keys for LLM Proxies
 */
export const getLlmProxyLabelKeys = <ThrowOnError extends boolean = false>(options?: Options<GetLlmProxyLabelKeysData, ThrowOnError>) => (options?.client ?? client).get<GetLlmProxyLabelKeysResponses, GetLlmProxyLabelKeysErrors, ThrowOnError>({ url: '/api/llm-proxy-entities/labels/keys', ...options });

/**
 * Get all available label values for LLM Proxies
 */
export const getLlmProxyLabelValues = <ThrowOnError extends boolean = false>(options?: Options<GetLlmProxyLabelValuesData, ThrowOnError>) => (options?.client ?? client).get<GetLlmProxyLabelValuesResponses, GetLlmProxyLabelValuesErrors, ThrowOnError>({ url: '/api/llm-proxy-entities/labels/values', ...options });

/**
 * Get auto-discovered tools for an LLM Proxy
 */
export const getLlmProxyTools = <ThrowOnError extends boolean = false>(options: Options<GetLlmProxyToolsData, ThrowOnError>) => (options.client ?? client).get<GetLlmProxyToolsResponses, GetLlmProxyToolsErrors, ThrowOnError>({ url: '/api/llm-proxy-entities/{id}/tools', ...options });

/**
 * Get all MCP Gateways with pagination, sorting, and filtering
 */
export const getMcpGatewayEntities = <ThrowOnError extends boolean = false>(options?: Options<GetMcpGatewayEntitiesData, ThrowOnError>) => (options?.client ?? client).get<GetMcpGatewayEntitiesResponses, GetMcpGatewayEntitiesErrors, ThrowOnError>({ url: '/api/mcp-gateways', ...options });

/**
 * Create a new MCP Gateway
 */
export const createMcpGatewayEntity = <ThrowOnError extends boolean = false>(options: Options<CreateMcpGatewayEntityData, ThrowOnError>) => (options.client ?? client).post<CreateMcpGatewayEntityResponses, CreateMcpGatewayEntityErrors, ThrowOnError>({
...
/**
 * Get all MCP Gateways without pagination
 */
export const getAllMcpGatewayEntities = <ThrowOnError extends boolean = false>(options?: Options<GetAllMcpGatewayEntitiesData, ThrowOnError>) => (options?.client ?? client).get<GetAllMcpGatewayEntitiesResponses, GetAllMcpGatewayEntitiesErrors, ThrowOnError>({ url: '/api/mcp-gateways/all', ...options });

/**
 * Get or create default MCP Gateway
 */
export const getDefaultMcpGatewayEntity = <ThrowOnError extends boolean = false>(options?: Options<GetDefaultMcpGatewayEntityData, ThrowOnError>) => (options?.client ?? client).get<GetDefaultMcpGatewayEntityResponses, GetDefaultMcpGatewayEntityErrors, ThrowOnError>({ url: '/api/mcp-gateways/default', ...options });

/**
 * Delete an MCP Gateway
 */
export const deleteMcpGatewayEntity = <ThrowOnError extends boolean = false>(options: Options<DeleteMcpGatewayEntityData, ThrowOnError>) => (options.client ?? client).delete<DeleteMcpGatewayEntityResponses, DeleteMcpGatewayEntityErrors, ThrowOnError>({ url: '/api/mcp-gateways/{id}', ...options });

/**
 * Get MCP Gateway by ID
 */
export const getMcpGatewayEntity = <ThrowOnError extends boolean = false>(options: Options<GetMcpGatewayEntityData, ThrowOnError>) => (options.client ?? client).get<GetMcpGatewayEntityResponses, GetMcpGatewayEntityErrors, ThrowOnError>({ url: '/api/mcp-gateways/{id}', ...options });

/**
 * Update an MCP Gateway
 */
export const updateMcpGatewayEntity = <ThrowOnError extends boolean = false>(options: Options<UpdateMcpGatewayEntityData, ThrowOnError>) => (options.client ?? client).put<UpdateMcpGatewayEntityResponses, UpdateMcpGatewayEntityErrors, ThrowOnError>({
...
/**
 * Get all available label keys for MCP Gateways
 */
export const getMcpGatewayEntityLabelKeys = <ThrowOnError extends boolean = false>(options?: Options<GetMcpGatewayEntityLabelKeysData, ThrowOnError>) => (options?.client ?? client).get<GetMcpGatewayEntityLabelKeysResponses, GetMcpGatewayEntityLabelKeysErrors, ThrowOnError>({ url: '/api/mcp-gateways/labels/keys', ...options });

/**
 * Get all available label values for MCP Gateways
 */
export const getMcpGatewayEntityLabelValues = <ThrowOnError extends boolean = false>(options?: Options<GetMcpGatewayEntityLabelValuesData, ThrowOnError>) => (options?.client ?? client).get<GetMcpGatewayEntityLabelValuesResponses, GetMcpGatewayEntityLabelValuesErrors, ThrowOnError>({ url: '/api/mcp-gateways/labels/values', ...options });
 ...
 */
export const getAllPromptTools = <ThrowOnError extends boolean = false>(options?: Options<GetAllPromptToolsData, ThrowOnError>) => (options?.client ?? client).get<GetAllPromptToolsResponses, GetAllPromptToolsErrors, ThrowOnError>({ url: '/api/prompt-tools', ...options });

/**
 * Get all tools directly assigned to a prompt (for A2A/Chat execution)
 */
export const getPromptAssignedTools = <ThrowOnError extends boolean = false>(options: Options<GetPromptAssignedToolsData, ThrowOnError>) => (options.client ?? client).get<GetPromptAssignedToolsResponses, GetPromptAssignedToolsErrors, ThrowOnError>({ url: '/api/prompts/{promptId}/assigned-tools', ...options });

/**
 * Unassign a tool from a prompt
 */
export const unassignToolFromPrompt = <ThrowOnError extends boolean = false>(options: Options<UnassignToolFromPromptData, ThrowOnError>) => (options.client ?? client).delete<UnassignToolFromPromptResponses, UnassignToolFromPromptErrors, ThrowOnError>({ url: '/api/prompts/{promptId}/tools/{toolId}', ...options });

/**
 * Assign a tool to a prompt
 */
export const assignToolToPrompt = <ThrowOnError extends boolean = false>(options: Options<AssignToolToPromptData, ThrowOnError>) => (options.client ?? client).post<AssignToolToPromptResponses, AssignToolToPromptErrors, ThrowOnError>({
...
/**
 * Assign multiple tools to multiple prompts in bulk
 */
export const bulkAssignToolsToPrompts = <ThrowOnError extends boolean = false>(options: Options<BulkAssignToolsToPromptsData, ThrowOnError>) => (options.client ?? client).post<BulkAssignToolsToPromptsResponses, BulkAssignToolsToPromptsErrors, ThrowOnError>({
...
/**
 * Update a prompt-tool relationship
 */
export const updatePromptTool = <ThrowOnError extends boolean = false>(options: Options<UpdatePromptToolData, ThrowOnError>) => (options.client ?? client).patch<UpdatePromptToolResponses, UpdatePromptToolErrors, ThrowOnError>({
 ...
 */
export const syncPromptTools = <ThrowOnError extends boolean = false>(options: Options<SyncPromptToolsData, ThrowOnError>) => (options.client ?? client).post<SyncPromptToolsResponses, SyncPromptToolsErrors, ThrowOnError>({
